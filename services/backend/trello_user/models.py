...
class TrelloUser(AbstractUser):
    ...
    banner = models.ImageField(upload_to=get_upload_file_name, null=True, blank=True)
    avatar = models.ImageField(upload_to=get_upload_file_name, null=True, blank=True)
